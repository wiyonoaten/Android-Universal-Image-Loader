...
namespace Nostra13UniversalImageLoader.SampleApp
{
    ...
    public sealed class Constants
    {
	    public static readonly string[] IMAGES = new string[] 
        {
			    ...
			    "drawable://" + Resource.Drawable.ic_launcher, // Image from drawables
        ...
        {
		    public const string FRAGMENT_INDEX = "com.nostra13.example.universalimageloader.FRAGMENT_INDEX";
		    public const string IMAGE_POSITION = "com.nostra13.example.universalimageloader.IMAGE_POSITION";
	    }
    }
}